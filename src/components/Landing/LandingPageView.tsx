    ...
    <div id="landing-page-root" className="min-h-screen bg-[#131313] text-[#FAF9F6] selection:bg-[#f2ca50] selection:text-[#131313] font-sans">
      ...
      <header className="sticky top-0 z-50 w-full bg-[#131313]/90 backdrop-blur-xl border-b border-[#4d4635]/25 px-4 md:px-12 py-3.5 transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Brand Logo */}
          <div className="flex items-center gap-3 cursor-pointer" onClick={handlePrimaryCta}>
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#f2ca50] to-[#d4af37] flex items-center justify-center text-[#131313] font-bold shadow-lg shadow-[#f2ca50]/20">
              <span className="material-symbols-outlined text-[22px]">auto_awesome</span>
            </div>
            <div>
              <span className="font-wordmark text-base md:text-lg uppercase tracking-[0.35em] text-[#f2ca50] font-bold block">
                STARWIRE
              </span>
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-mono tracking-wider uppercase text-[#d0c5af]">
            ...
            <a href="#terminal-preview" className="hover:text-[#f2ca50] transition-colors">
              AI Terminal Preview
            </a>
            <a href="#global-coverage" className="hover:text-[#f2ca50] transition-colors">
              Global Coverage
            </a>
          </nav>
      ...
      <section className="relative overflow-hidden pt-16 md:pt-24 pb-20 md:pb-32 px-4 md:px-12 border-b border-[#4d4635]/20">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 space-y-8">
          ...
          <div className="flex justify-center pt-4">
            <button
              onClick={handlePrimaryCta}
              className="flex items-center gap-2.5 px-9 py-4.5 rounded-2xl bg-[#f2ca50] hover:bg-[#ffe088] text-[#131313] font-bold text-sm uppercase tracking-wider transition-all shadow-[0_0_35px_rgba(242,202,80,0.4)] hover:scale-102 cursor-pointer font-data-label"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto pt-12 border-t border-[#4d4635]/25 text-left">
            <div className="p-4 rounded-2xl bg-[#1c1b1b]/80 border border-[#4d4635]/30 shadow-lg">
              <span className="text-[10px] font-mono text-[#99907c] uppercase tracking-widest block font-bold">Tracked Box Office</span>
              <span className="font-headline-md text-2xl md:text-3xl text-[#10B981] font-bold">$4.8B+</span>
            ...
            <div className="p-4 rounded-2xl bg-[#1c1b1b]/80 border border-[#4d4635]/30 shadow-lg">
              ...
              <span className="font-headline-md text-2xl md:text-3xl text-[#f2ca50] font-bold">12,400+</span>
            ...
            <div className="p-4 rounded-2xl bg-[#1c1b1b]/80 border border-[#4d4635]/30 shadow-lg">
              ...
              <span className="font-headline-md text-2xl md:text-3xl text-[#FAF9F6] font-bold">96.4%</span>
      ...
      <section id="terminal-preview" className="py-20 px-4 md:px-12 max-w-7xl mx-auto space-y-10">
        ...
        <div className="bg-[#1c1b1b] border border-[#f2ca50]/30 rounded-2xl overflow-hidden shadow-2xl space-y-0">
          {/* Window Titlebar */}
            ...
            <div className="flex items-center gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1 text-xs font-mono rounded-lg transition-all cursor-pointer ${activePreviewTab === tab.key
                    ? 'bg-[#f2ca50] text-[#131313] font-bold'
            ...
            {activePreviewTab === 'ai' && (
              <div className="space-y-6 animate-fade-in">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#4d4635]/30 pb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <img
                      ...
                      alt="Tom Hanks"
                      className="w-16 h-16 rounded-xl object-cover border-2 border-[#f2ca50] shadow-md"
                  ...
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 rounded-full bg-[#10B981]/20 text-[#10B981] border border-[#10B981]/30 text-xs font-mono font-bold">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl bg-[#131313] border border-[#4d4635]/30 space-y-1">
            ...
            {activePreviewTab === 'boxOffice' && (
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 rounded-xl bg-[#131313] border border-[#4d4635]/30 space-y-2">
            ...
            {activePreviewTab === 'dossier' && (
              <div className="space-y-4 animate-fade-in">
                ...
                <div className="space-y-2 font-mono text-xs">
                  <div className="p-3 rounded-xl bg-[#131313] border border-[#4d4635]/30 flex items-center justify-between">
      ...
      {/* 5. Global Cinema Coverage & Intelligence Network (Replaces Pricing Section) */}
      <section id="global-coverage" className="py-20 px-4 md:px-12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          {/* Market 1 */}
          <div className="p-8 rounded-2xl bg-[#1c1b1b] border border-[#4d4635]/30 flex flex-col justify-between space-y-6 shadow-xl">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#f2ca50]/15 border border-[#f2ca50]/30 flex items-center justify-center text-[#f2ca50]">
              ...
              <h3 className="font-headline-md text-2xl text-[#FAF9F6]">Bollywood &amp; Pan-Indian Cinema</h3>
              <p className="text-xs text-[#d0c5af] font-light leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-[#1c1b1b] border border-[#4d4635]/30 flex flex-col justify-between space-y-6 shadow-xl">
            <div className="space-y-4">
              ...
              <h3 className="font-headline-md text-2xl text-[#FAF9F6]">Hollywood Studio Pipeline</h3>
              <p className="text-xs text-[#d0c5af] font-light leading-relaxed">
          ...
          <div className="p-8 rounded-2xl bg-[#1c1b1b] border border-[#4d4635]/30 flex flex-col justify-between space-y-6 shadow-xl">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-[#06B6D4]/15 border border-[#06B6D4]/30 flex items-center justify-center text-[#06B6D4]">
                <span className="material-symbols-outlined text-[26px]">public</span>
              </div>
              <span className="text-xs font-mono text-[#06B6D4] uppercase tracking-widest font-bold">OVERSEAS &amp; IMAX CIRCUITS</span>
              <h3 className="font-headline-md text-2xl text-[#FAF9F6]">Global Distribution Footprint</h3>
              <p className="text-xs text-[#d0c5af] font-light leading-relaxed">
